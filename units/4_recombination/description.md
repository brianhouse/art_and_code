...
For this code, please begin by downloading [this template](template), which includes additional functions and libraries. Although we will continue to work with text, we will be working in the Processing app, not in the terminal.
...
BTW, the word lists included in the template folder are:

To add your own, use the "Add File" option in Processing:
