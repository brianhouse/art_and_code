...
For this code, please begin by downloading [this template](recombination_sketch.zip), which includes additional functions and libraries. Although we will continue to work with text, we will be working in the Processing app, not in the terminal.
