...
Along with your code and [3-sentence statement](../../resources/statement_guidelines.md), you should supply an image that you have created to demonstrate the capabilities of your interface and a [video](https://github.com/brianhouse/art_and_code/blob/master/resources/movie_maker.md]) that shows you using it. Your interface must include at least four different "brushes" or ways of interacting. For crit, you will swap interfaces with each other.
